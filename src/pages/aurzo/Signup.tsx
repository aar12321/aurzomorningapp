...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // After sign-up the trigger creates the aurzo_user_profiles row;
  ...
  const passwordStrength = () => {
    ...
    if (password.length < 12) return { label: 'Good', color: '#22c55e', width: '75%' };
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12"
        ...
        <div className="relative z-10 max-w-md text-center">
          ...
          <h1 className="text-4xl font-bold text-foreground mb-4">Join Aurzo</h1>
          <p className="text-xl text-muted-foreground mb-8">
            One account. Four powerful platforms. Unlimited growth.
          </p>
          <div className="space-y-3 text-left">
            {[
              'Daily learning quizzes that build real knowledge',
              'AI tools that work with your actual calendar',
              'Finance tracking built for your goals',
      ...
      <div className="flex-1 flex items-center justify-center p-6 overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h1 className="text-xl font-bold text-foreground">Aurzo</h1>
          </div>
          ...
          <div className="aurzo-card p-8">
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center">
                <span className="bg-card px-4 text-sm text-muted-foreground">or with email</span>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-3 rounded-xl border border-input bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all text-sm"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-3 rounded-xl border border-input bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all text-sm"
                  />
                </div>
              </div>
            ...
            <div className="flex items-start gap-2.5 mt-5 p-3.5 rounded-xl bg-secondary">
              <Shield className="w-4 h-4 text-primary shrink-0 mt-0.5" />
              <p className="text-xs text-muted-foreground">
                End-to-end encrypted. Your data stays yours — always.
              </p>
            </div>
          </div>
